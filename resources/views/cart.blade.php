      ...
      <div class="flex shadow-md my-10">
          ...
          @foreach ($products as $key=>$product)
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                ...
                <div class="flex justify-center w-1/5">
                    <input class="mx-2 border text-center w-8" onchange="update_prices()" id="{{'qte'.$product->id}}" type="text" value="1">
                </div>
        ...
        <div id="summary" class="w-1/4 px-8 py-10">
          ...
          <div class="mt-8">
            ...
            <button class="bg-yellow-500 rounded py-3 text-sm text-white uppercase w-full">Order</button>
          </div>
        </div>
    ...
    <script>
        ...
        function update_prices(){
            ...
            choosedItems.forEach(el => {
                ...
                total_product_price.innerHTML = price + " Dhs";
            });
        }
